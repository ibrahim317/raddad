export const NOTIFICATION_TYPES_MAPPING = {
  CONVERSATION_MENTION: ['i-lucide-at-sign', 'text-n-mint-text'],
  CONVERSATION_ASSIGNMENT: ['i-lucide-chevrons-right', 'text-n-mint-text'],
  CONVERSATION_CREATION: ['i-lucide-mail-plus', 'text-n-mint-text'],
